...
use App\Http\Controllers\FaceconditionController;
...
Route::post('/Timestamps', [CommentsController::class, 'post']);
Route::post('/Facecondition', [CommentsController::class, 'post']);
